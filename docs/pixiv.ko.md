...
단축키 위주의 픽시브 뷰어입니다. PC 크롬, 파폭에서 쓸 수 있습니다.
...
3. [픽시브 뷰어 스크립트](https://greasyfork.org/scripts/428229-/code/pixiv_viewer.user.js)를
   설치합니다. (확장을 설치해야 설치 페이지가 열립니다)

4. 픽시브 페이지를 새로고침하고 주소 표시줄 오른쪽에 빨간 숫자가 뜨는지 확인합니다.
